<?php
class Silaslite_Social_Network_Widget extends WP_Widget
{
	public function __construct()
    {
		$widget_ops = array( 'classname' => 'widget_silaslite_social_network', 'description' => esc_html__('A widget that displays your social icons', 'silaslite') );
		parent::__construct( 'widget_silaslite_social_network', esc_html__('Silaslite: Social Network', 'silaslite'), $widget_ops );
	}
    ...
    {
		$defaults = array(
            'title'              => empty($instance['title']) ? esc_html__('Follow Us', 'silaslite') : $instance['title'],
            'follow_desc'   => '',
            'facebook_check' => '',
            'twitter_check' => '',
            'instagram_check' => '',
		...
		?>
		<p>
            <label for="<?php echo esc_attr( $this->get_field_id('title') ); ?>"><?php esc_html_e('Title:', 'silaslite'); ?></label>
            <input  type="text" class="widefat" id="<?php echo esc_attr( $this->get_field_id('title') ); ?>" name="<?php echo esc_attr( $this->get_field_name('title') ); ?>" value="<?php echo esc_attr($instance['title']); ?>"  />
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_name('follow_desc')); ?>"><?php esc_html_e('Follow Description', 'silaslite'); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'facebook_check' ) ); ?>"><?php echo esc_html__( 'Facebook :', 'silaslite' ) ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'twitter_check' )); ?>"><?php echo esc_html__( 'Twitter :', 'silaslite' ) ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'instagram_check' )); ?>"><?php echo esc_html__( 'Instagram :', 'silaslite' ) ?></label>
        ...
        <p>
			<label for="<?php echo esc_attr($this->get_field_id( 'pinterest_check' )); ?>"><?php echo esc_html__( 'Pinterest :', 'silaslite' ) ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'youtube_check' )); ?>"><?php echo esc_html__( 'Youtube :', 'silaslite' ) ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'vimeo_check' )); ?>"><?php echo esc_html__( 'Vimeo :', 'silaslite' ) ?></label>
...
add_action( 'widgets_init', 'widget_silaslite_social_network_init' );
function widget_silaslite_social_network_init() {
	register_widget( 'Silaslite_Social_Network_Widget' );
}
